resource "aws_cloudfront_distribution" "marketplace_dev" {
  origin {
    domain_name = "s3-ue2-dev-naemo-fe-marketplace.s3.amazonaws.com"
    origin_id   = "s3origin"
    
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.marketplace_dev.cloudfront_access_identity_path
    }
  }
  ...
  comment             = "Marketplace Frontend(dev)"
...
resource "aws_cloudfront_origin_access_identity" "marketplace_dev" {
  comment = "marketplace_dev"
}
resource "aws_cloudfront_distribution" "marketplace_nprd" {
  origin {
    domain_name = "s3-ue2-nprd-naemo-fe-marketplace.s3.amazonaws.com"
    origin_id   = "s3origin"
    
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.marketplace_nprd.cloudfront_access_identity_path
    }
  }

  origin {
    domain_name = "s3-ue2-nprd-naemo-launchpad.s3.amazonaws.com"
  ...
  origin {
    domain_name = "s3-ue2-nprd-naemo-collection.s3.amazonaws.com"
  ...
  origin {
    domain_name = "s3-ue2-nprd-naemo-member.s3.amazonaws.com"
  ...
  origin {
    domain_name = "s3-ue2-nprd-naemo-nft.s3.amazonaws.com"
  ...
  comment             = "Marketplace Frontend(nprd)"
...
resource "aws_cloudfront_origin_access_identity" "marketplace_nprd" {
  comment = "marketplace_nprd"
}
resource "aws_cloudfront_distribution" "backend_stg" {
  origin {
    domain_name = "alb-ue2-net-stg-service-26170110.us-east-2.elb.amazonaws.com"
    origin_id   = "alb-ue2-net-stg-service-26170110.us-east-2.elb.amazonaws.com"
  ...
  aliases = ["marketplace.stg.naemo.io", "launchpadruntime.stg.naemo.io", "metaverse.stg.naemo.io"]

  default_cache_behavior {
    allowed_methods  = ["DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT"]
    cached_methods   = ["GET", "HEAD", "OPTIONS"]
    target_origin_id = "alb-ue2-net-stg-service-26170110.us-east-2.elb.amazonaws.com"

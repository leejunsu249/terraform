...
resource "aws_subnet" "private_lb_subnet_2" {
  ...
  tags = {
    Name = "sbn-${var.aws_region_shot}-${var.environment}-pri-lb-2-2c"
    "kubernetes.io/role/internal-elb" = 1,
    System                      = "network",
    BusinessOwnerPrimary        = "infra@bithumbmeta.io",
    SupportPlatformOwnerPrimary = "BithumMeta",
...
resource "aws_subnet" "private_inner_subnet_2" {
  ...
  tags = {
    Name = "sbn-${var.aws_region_shot}-${var.environment}-pri-inner-2-2c",
    System                      = "network",
    BusinessOwnerPrimary        = "infra@bithumbmeta.io",
    SupportPlatformOwnerPrimary = "BithumMeta",
    OperationLevel              = "1"
...
resource "aws_subnet" "private_app_subnet_2" {
  ...
  tags = {
    Name = "sbn-${var.aws_region_shot}-${var.environment}-pri-app-2-2c",
    System                      = "network",
    BusinessOwnerPrimary        = "infra@bithumbmeta.io",
    SupportPlatformOwnerPrimary = "BithumMeta",
    OperationLevel              = "1"
